...
const IntroductionOfJs = () => {
  return (
    <>
      <Helmet>
        <title>Introduction to JavaScript | JavaScript Tutorial</title>
        <meta name="description" content="Learn what JavaScript is, where it is used, and why it's essential for modern web development. This introduction covers key features and uses of JavaScript." />
        <meta name="keywords" content="JavaScript, Introduction to JavaScript, What is JavaScript, JavaScript features, JavaScript usage, JavaScript tutorial" />
        <meta name="author" content="CodePan Blogs" />
        <meta property="og:title" content="Introduction to JavaScript | JavaScript Tutorial" />
        <meta property="og:description" content="Discover the fundamentals of JavaScript including its features, usage, and importance in web development." />
        <meta property="og:type" content="article" />
        <meta property="og:url" content="https://code-pan-red.vercel.app/topics/javascript/introduction" />
        <meta property="og:image" content="https://code-pan-red.vercel.app/images/js-intro-banner.png" />
      </Helmet>
